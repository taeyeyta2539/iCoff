...
{
size(640, 600);
//String[] lines = loadStrings("arabica.txt");
String lines2 = "";
...
//////////////////////////////////////////////////////////////////////
    ...
    myTextarea = cp5.addTextarea("txt")
                  ...
                  ;
  for(int i = 0 ; i < arabica.length ;i++){lines2+=arabica[i];}
  myTextarea.setText(lines2
                    );
  cp5.end();
...
///////////////////////////////////////////////////////////////////////
  ...
  midimapper.put( ref( device, 18 ), "c-1" );
...
myval3 = split[2];
keepNumberOfMyval3 = int(myval3.substring(0,2));
myval3 = myval3.substring(2);
myval3 = myval3.substring(0,keepNumberOfMyval3);
println("keepNumberOfMyval3 : "+keepNumberOfMyval3);
